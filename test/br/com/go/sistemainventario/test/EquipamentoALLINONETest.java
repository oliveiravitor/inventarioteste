 ...
 * @author oliveira
 */
public class EquipamentoALLINONETest {
    ...
    public EquipamentoALLINONETest() {
    }

    @BeforeClass
    public static void setUpClass() {
//        boolean restoreDB = RestaurarBackupMYSQL.restoreDB();
//        if (!restoreDB) {
...
//            );
        ...
        usuariofinal = new UsuarioFinal.Builder()
                ...
                .matriculaUsuario(1)
                .emailUsuario("estoque@patrimonio.com")
    ...
    public void cadastrarEquipamento() throws SQLException {
        Equipamento equipamentoDesktop = new Equipamento.Builder()
                ...
                .origemEquip('P')
                .modeloEquip("I3")
                .numSerieEquip("34554265FBR")
                .numSerieGabineteEquip("43524343265FRA2334")
                .numSerieMouseEquip("ABRH53463455546")
                .numSerieTecladoEquip("TTeS-4325425-BR")
                .construir();
